using Litethinking.NetInventory.Backend.Application.Constants;
...
namespace Litethinking.NetInventory.Backend.Identity.Services
{
    public class AuthService : IAuthService
    {
        ...
        private async Task<JwtSecurityToken> GenerateToken(ApplicationUser user)
        {
            ...
            //Creamos la llave de seguridad
            var symmetricSecurityKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_jwtSettings.Key)); // clave de seeguridad almazenada en jwtsettings
